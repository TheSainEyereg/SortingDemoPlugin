...
public class SortSelectionCommand implements CommandExecutor {
	@Override
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		SimpleSort.selectionSort(DisplayManager.numbers);
		DisplayManager.render();

		sender.sendMessage("Preformed selection sort");
